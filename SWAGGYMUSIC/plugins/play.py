...
from SWAGGYMUSIC import SWAGGYMUSIC, app, config, db, lang, queue, tg, yt
from SWAGGYMUSIC.helpers import buttons, utils
from SWAGGYMUSIC.helpers._play import checkUB
...
async def play_hndlr(
    ...
    await SWAGGYMUSIC.play_media(chat_id=m.chat.id, message=sent, media=file)
    if not tracks:
        return
    added = playlist_to_queue(m.chat.id, tracks)
    await app.send_message(
