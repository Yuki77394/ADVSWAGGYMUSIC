...
from SWAGGYMUSIC import config, logger, userbot
...
class MongoDB:
    ...
    async def get_admins(self, chat_id: int, reload: bool = False) -> list[int]:
        from SWAGGYMUSIC.helpers._admins import reload_admins
    ...
    async def get_assistant(self, chat_id: int):
        from SWAGGYMUSIC import SWAGGYMUSIC
        ...
        return SWAGGYMUSIC.clients[self.assistant[chat_id] - 1]
